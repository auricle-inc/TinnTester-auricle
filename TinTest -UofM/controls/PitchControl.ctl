VERSION 5.00
Begin VB.UserControl PitchControl 
   ...
   Begin VB.PictureBox Picturemiddle_F 
      ...
      Height          =   4110
      Left            =   0
      Picture         =   "PitchControl.ctx":AD684
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   6
      Top             =   0
   ...
   Begin VB.PictureBox Pictureleft_F 
      ...
      Height          =   4110
      Left            =   0
      Picture         =   "PitchControl.ctx":15AD08
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   5
      Top             =   0
   ...
   Begin VB.PictureBox PictureClick_F 
      ...
      Height          =   4110
      Left            =   0
      Picture         =   "PitchControl.ctx":20838C
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   4
      Top             =   0
   ...
   Begin VB.PictureBox PictureClick 
      ...
      Height          =   4110
      Left            =   0
      Picture         =   "PitchControl.ctx":2B5A10
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   3
      Top             =   0
   ...
   Begin VB.PictureBox Pictureleft 
      ...
      Height          =   4110
      Left            =   480
      Picture         =   "PitchControl.ctx":363094
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   0
      Top             =   840
   ...
   Begin VB.PictureBox Pictureright 
      ...
      Height          =   4110
      Left            =   360
      Picture         =   "PitchControl.ctx":410718
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   2
      Top             =   480
   ...
   Begin VB.PictureBox Picturemiddle 
      ...
      Height          =   4110
      Left            =   0
      Picture         =   "PitchControl.ctx":4BDD9C
      ScaleHeight     =   4110
      ScaleWidth      =   9720
      TabIndex        =   1
      Top             =   0
   ...
   End
End
Attribute VB_Name = "PitchControl"
